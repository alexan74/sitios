	...
	<div class="card shadow mb-4">
        ...
        <div class="card-body">
			...
			<div class="row">
              	<div class="col-sm-12">
              		<div class="col-sm-6">
                		<label for="tipo" class="col-sm-3 control-label">Archivos</label>
              	...
              	<div class="col-sm-12">
    				...
    				<?php if (!empty($empresa->tramites)) { ?>
        				<table class="table table-bordered" width="100%" cellspacing="0">
                            <thead>
                            	<tr>
                            		<th width="25%">Tipo de tramite</th>
                            ...
                            <tbody>
                        	    ...
                        	    <tr>
									...
									<td><?= ($tramite->fecha)?$tramite->fecha->format('d/m/Y'):'' ?></td>
                        		  	<td>
                        		  	<?php if (!empty($item->Empresas['archivos'])) { 
                                        foreach ($item->Empresas['archivos'] as $archivo) {
                                	        echo '<i class="fas fa-angle-right"></i> '.$this->Html->link($archivo->nombre, ['controller'=>'Empresas', 'action' => 'download', $archivo->id], ['escape' => false]).'&nbsp;';
                                	        echo '<button type="button" class="btn btn-sm btn-danger" data-id="'.$archivo['id'].'" onclick="borrar_archivo(this)"><i class="fas fa-times-circle"> </i></button><br />';
                                	    } 
                                	} ?>
                                	</td>    
