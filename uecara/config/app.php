<?php
define('DIRHOST','');  // Carpeta del host
return [
    /**
     * Debug Level:
     *
    ...
    'Security' => [
        ...
        //'salt' => env('SECURITY_SALT', 'd8555a67b164df2309aa2e626dafb7d353ce8fd164a224f9fd9e7acc4924cd0c')
    ],
    ...
    'EmailTransport' => [
        ...
        /*'default' => [
            ...
            'username'=>'alexan74@gmail.com',
            'password'=>'HwUL3NpA9O8yb1nP',
            'transport' => 'Smtp',
            'timeout'=>'30',
            'tls' => true,
            'client' => null,
        ...
        'default' => [
            'className' => 'Smtp',
            'port'=>'465',
            'host' => 'ssl://vcct6001.avnam.net',
            'username'=>'administracion@uecaradelinterior.org.ar',
            'password'=>'nahE3MrA',
            'transport' => 'Smtp',
            'timeout'=>'30',
            'tls' => false,
